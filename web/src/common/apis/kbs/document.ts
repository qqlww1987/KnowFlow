...
export function getDocumentListApi(params: {
  ...
  return request({
    url: `/api/knowflow/v1/knowledgebases/${params.kb_id}/documents`,
    method: 'get',
    params: {
...
export function getDocumentDetailApi(id: string) {
  return request({
    url: `/api/knowflow/v1/documents/${id}`,
    method: 'get',
  });
}
...
export function getDocumentParseProgress(docId: any) {
  return request({
    url: `/api/knowflow/v1/knowledgebases/documents/${docId}/parse/progress`,
    method: 'get',
  });
}
...
export function startDocumentParse(docId: any) {
  return request({
    url: `/api/knowflow/v1/knowledgebases/documents/${docId}/parse`,
    method: 'post',
  });
}
...
export function uploadDocumentApi(formData: FormData): Promise<any> {
  return request<UploadResponse>({
    url: '/api/knowflow/v1/knowledgebases/documents/upload',
    method: 'post',
    data: formData,
    headers: {
...
export function deleteDocumentApi(docId: string) {
  return request({
    url: `/api/knowflow/v1/knowledgebases/documents/${docId}`,
    method: 'delete',
  });
}
...
export function batchDeleteDocumentsApi(ids: string[]) {
  return request({
    url: '/api/knowflow/v1/knowledgebases/documents/batch',
    method: 'delete',
    data: { ids },
  });
}
...
export function changeDocumentStatusApi(id: string, status: string) {
  return request({
    url: `/api/knowflow/v1/knowledgebases/documents/${id}/status`,
    method: 'put',
    data: { status },
  });
}
...
export function runDocumentParseApi(id: string) {
  return request({
    url: `/api/knowflow/v1/knowledgebases/documents/${id}/parse`,
    method: 'post',
  });
}
...
export function startSequentialBatchParseAsyncApi(kbId: string) {
  ...
  return request<StartBatchResponse>({
    url: `/api/knowflow/v1/knowledgebases/${kbId}/batch_parse_sequential/start`, // 指向新的启动路由
    method: 'post',
  });
}
...
export function getSequentialBatchParseProgressApi(kbId: string) {
  return request<BatchProgressResponse>({
    url: `/api/knowflow/v1/knowledgebases/${kbId}/batch_parse_sequential/progress`, // 指向新的进度路由
    method: 'get',
  });
}
...
export function updateDocumentChunkingConfigApi(data: {
  ...
  return request({
    url: `/api/knowflow/v1/documents/${data.doc_id}/chunking-config`,
    method: 'put',
...
export function getDocumentChunkingConfigApi(doc_id: string) {
  return request({
    url: `/api/knowflow/v1/documents/${doc_id}/chunking-config`,
    method: 'get',
  });
}
