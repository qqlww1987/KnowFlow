...
from .utils import split_markdown_to_chunks_advanced, get_bbox_for_chunk, update_document_progress
...
def create_ragflow_resources(doc_id, kb_id, md_file_path, image_dir, update_progress):
    ...
    try:
        ...
        chunks = split_markdown_to_chunks_advanced(enhanced_text, chunk_token_num=512)
